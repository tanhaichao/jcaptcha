 ...
 * </ul>
 * <p/>
 * This is a container for the CAPTCHA challenge which is also able to validate
 * the answer. Class implementing this interface must follow the rules :
 * <ul>
 * <li>As all 'components' of this project, all contructed objects should be
 * abble to word (ie no need to set other properties to obtain a fully
 * fonctional object). constructor</li>
 ...
 * <li>It must dispose the challenge when the getChallenge method is called(The
 * challenge must be showed only once )</li>
 * </ul>
 * ;
 * 
 * @author Marc-Antoine Garrigue
 * @version $Id: Captcha.java 493 2009-02-14 12:00:39Z magarrigue $
 */
