 ...
 * <li>Response type : a point position, in pixels from the bottom left, can be
 * : a String with two numbers separated with a comma or a java.awt.Point</li>
 * <li>Description : An image of a distorded picture. User have to point the
 * center of the deformation and to submit it.</li>
 * </ul>
 * 
...
public class FishEye extends ImageCaptcha {
	 ...
	 * @param challenge
	 *            the imageChallenge
	 * @param deformationCenter
	 *            the center of the deformation that has been applied to the
	 *            image in order to validate the answer
	 * @param tolerance
	 *            the max distance to the center of the deformation accepted by
	 *            the validation routine in pixels.
	 */
